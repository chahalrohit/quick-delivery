...
function PhotoDetailTwoScreen({ navigation }: any) {
      ...
      <Container statusBarColorWhite conatinerStyle={styles.conatinerStyle}>
        ...
        <Content contentContainerStyle={styles.container}>
          <View style={styles.customContainer}>
            <TouchableOpacity disabled style={styles.foodRoundCoverImg}>
              <Image
                source={Images.PhotoDetailImg}
                resizeMode="contain"
                style={styles.foodCoverImgTwo}
              />
            </TouchableOpacity>
          </View>
...
export default PhotoDetailTwoScreen;
